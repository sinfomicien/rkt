...
$(call generate-stamp-rule,$(UFH_STAMP),,$(S1_RF_ACIROOTFSDIR), \
	...
	ln -sf 'usr/lib64' "$(S1_RF_ACIROOTFSDIR)/usr/lib" && \
	ln -sf 'lib' "$(S1_RF_ACIROOTFSDIR)/usr/lib" && \
	ln -sf 'lib64' "$(S1_RF_ACIROOTFSDIR)/usr/lib64")


CLEAN_SYMLINKS += $(S1_RF_ACIROOTFSDIR)/flavor $(S1_RF_ACIROOTFSDIR)/lib64 $(S1_RF_ACIROOTFSDIR)/lib $(S1_RF_ACIROOTFSDIR)/usr/lib64
